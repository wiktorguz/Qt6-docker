...
RUN wget https://download.qt.io/official_releases/qt/6.0/6.0.2/single/qt-everywhere-src-6.0.2.tar.xz
RUN tar -xf qt-everywhere-src-6.0.2.tar.xz
WORKDIR qt-everywhere-src-6.0.2
RUN mkdir build
WORKDIR build
RUN cmake .. -GNinja
